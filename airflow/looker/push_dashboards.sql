...
DELETE FROM MONITORING.LOOKER_ALERTS_CURRENT WHERE DASHBOARD_ID IN (SELECT DASHBOARD_ID FROM MONITORING.LOOKER_DASHBOARDS WHERE REPLACED_AT IS NOT NULL);
